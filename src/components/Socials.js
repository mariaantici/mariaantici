        ...
        <div className="fixed bottom-0 left-0 hidden sides:block">
            <div className="px-10 space-y-4">
                <div className="flex flex-col space-y-4">
                    {socials.map((social) => (
                        <a href={social.url} className='icon transition ease-in-out delay-100 hover:-translate-y-1 hover:scale-110 duration-300'><FontAwesomeIcon icon={social.icon} size="2x" /></a>
                    ))}
                </div>
