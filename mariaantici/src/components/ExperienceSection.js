...
export default function ExperienceSection() {
    return (
        <Section className="space-y-10 verticalTimeline" id='experience-section'>
            <H2>Experience</H2>
                    ...
                    >
                        {t.title ? <React.Fragment>
                            ...
                            <div className='inline-flex flex-wrap justify-start gap-x-1 sm:gap-x-3'>
                                {t.tech && t.tech.map((item, index) => <p key={index} className="rounded-3xl px-2 py-1 ring-1 ring-brown-black/10">{item}</p>)}
                            </div>
